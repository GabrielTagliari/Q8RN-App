...
public class PopulaBanco {
    ...
    private void inserirAll() {
        mQuestaoManager.insereQuestao(1,"Com que frequência você inclui em suas refeições diária todos " +
        ...
        mQuestaoManager.insereQuestao(2,"Quantas refeições você faz por dia? (Desjejum, almoço, jantar, " +
                "lanches, ceia)", "2 a 3", null, null, null, "4 ou mais", NUTRIÇÃO);

        mQuestaoManager.insereQuestao(3,"Além de consumir outros alimentos no dia a dia como: feijão, " +
        ...
        mQuestaoManager.insereQuestao(4, "Dos itens a seguir: salgadinhos, bolachas, frituras, " +
        ...
        mQuestaoManager.insereQuestao(5, "Você pratica atividades de lazer: caminhar, pedalar, " +
        ...
        mQuestaoManager.insereQuestao(6, "Quantas vezes por semana você pratica exercício físico vigoroso " +
        ...
        mQuestaoManager.insereQuestao(7, "Quantos minutos você gasta em média, em cada sessão de " +
                "exercício vigoroso?", "Acima de 30 minutos", "21 a 30 minutos", "10-20" +
                "minutos", "Menos de 10 minutos", NUNCA, EXERCÍCIO);

        mQuestaoManager.insereQuestao(8, "Quantos copos de água, em média, você bebe diariamente?",
                "8 ou mais", "7 copos", "4-6 copos", "1-3 copos", NENHUM, AGUA);

        mQuestaoManager.insereQuestao(9, "Você utiliza a água para tratamentos caseiros quando necessário? " +
        ...
        mQuestaoManager.insereQuestao(10, "Com que frequência você se expõe ao sol durante 15 a 20 " +
                "minutos/dia?",SEMPRE, COM_RELATIVA_FREQUENCIA, ALGUMAS_VEZES, QUASE_NUNCA, NUNCA,
                SOL);

        mQuestaoManager.insereQuestao(11, "Você mantém diariamente as janelas abertas da casa para " +
                "entrada de luz natural? ",SEMPRE, COM_RELATIVA_FREQUENCIA, ALGUMAS_VEZES,
                QUASE_NUNCA, NUNCA, SOL);

        mQuestaoManager.insereQuestao(12, "Você se considera equilibrado quanto ao tempo dedicado para estudos, " +
        ...
        mQuestaoManager.insereQuestao(13, "Você ingere bebida alcóolica (cerveja, vinho e bebidas " +
                "alcóolicas destiladas)?", NUNCA, null, null, null, ALGUMAS_VEZES, TEMPERANCA);

        mQuestaoManager.insereQuestao(14, "Você fuma cigarros, fumo de rolo ou charuto?", NUNCA, null,
                null, null, ALGUMAS_VEZES, TEMPERANCA);

        mQuestaoManager.insereQuestao(15, "Você faz uso de drogas como: maconha, crack, cocaína etc?",
                NUNCA, null, null, null, ALGUMAS_VEZES, TEMPERANCA);

        mQuestaoManager.insereQuestao(16, "Você ingere bebidas que contém cafeína? (café, chá preto, " +
                "chá verde, chá mate, chá branco ou refrigerantes de “cola”)", NUNCA, null, null,
                null, ALGUMAS_VEZES, TEMPERANCA);

        mQuestaoManager.insereQuestao(17, "Considerando os ambientes em que você vive, como classifica " +
                "a qualidade do ar que respira regularmente?", "Muito boa", "Boa", "Regular",
                "Ruim", "Muito ruim", AR_PURO);

        mQuestaoManager.insereQuestao(18, "Você pratica a respiração profunda em ambientes arejados?",
                SEMPRE, COM_RELATIVA_FREQUENCIA, ALGUMAS_VEZES, RARAMENTE, NUNCA, AR_PURO);

        mQuestaoManager.insereQuestao(19, "Você dorme entre 7 a 8h por noite (em média)?",
                SEMPRE, COM_RELATIVA_FREQUENCIA, ALGUMAS_VEZES, RARAMENTE, NUNCA, DESCANSO);

        mQuestaoManager.insereQuestao(20, "Você costuma dormir cedo? (por volta das 22h).",
                SEMPRE, COM_RELATIVA_FREQUENCIA, ALGUMAS_VEZES, RARAMENTE, NUNCA, DESCANSO);

        mQuestaoManager.insereQuestao(21, "Você separa um dia na semana para descansar?",
                SEMPRE, COM_RELATIVA_FREQUENCIA, ALGUMAS_VEZES, RARAMENTE, NUNCA, DESCANSO);

        mQuestaoManager.insereQuestao(22, "Você confia em Deus? (ou Ser Superior ou algo sagrado)",
                SEMPRE, COM_RELATIVA_FREQUENCIA, ALGUMAS_VEZES, RARAMENTE, NUNCA, CONFIANCA);

        mQuestaoManager.insereQuestao(23, "Sua confiança em Deus (Ser Superior ou algo sagrado) " +
                "influencia positivamente na sua maneira de viver?", SEMPRE, COM_RELATIVA_FREQUENCIA,
                ALGUMAS_VEZES, RARAMENTE, NUNCA, CONFIANCA);

        mQuestaoManager.insereQuestao(24, "Com que frequência você participa de reuniões religiosas ou " +
        ...
        mQuestaoManager.insereQuestao(25, "Você pratica as atividades religiosas ou espirituais em " +
